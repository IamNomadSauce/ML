...
class Activation_ReLU:
    ...
    def backward(self, dvalues):
        ...
        # Zero gradient where input values were negative1
...
fig, axs = plt.subplots(3, 1, figsize=(8, 12), facecolor='darkgray')
...
# After training, plot the loss, accuracy, and learning rate in vertically stacked subplots
